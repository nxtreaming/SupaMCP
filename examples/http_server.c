...
int main(int argc, char** argv) {
    ...
    if (sse_file) {
        ...
        fprintf(sse_file, "        <div class=\"status-bar\">\n");
        fprintf(sse_file, "            <span>Status: <span id=\"connection-status\" class=\"disconnected\">Disconnected</span></span>\n");
        fprintf(sse_file, "            <span>Last Event ID: <span id=\"last-event-id\">None</span></span>\n");
        fprintf(sse_file, "        </div>\n");
        fprintf(sse_file, "        \n");
        fprintf(sse_file, "        <div class=\"controls\">\n");
        fprintf(sse_file, "            <button id=\"connect-btn\">Connect</button>\n");
        fprintf(sse_file, "            <button id=\"disconnect-btn\">Disconnect</button>\n");
        fprintf(sse_file, "            <select id=\"event-filter\">\n");
        fprintf(sse_file, "                <option value=\"\">All Events</option>\n");
        fprintf(sse_file, "                <option value=\"echo\">Echo Events</option>\n");
        fprintf(sse_file, "                <option value=\"reverse\">Reverse Events</option>\n");
        fprintf(sse_file, "                <option value=\"tool_call\">Tool Call Events</option>\n");
        fprintf(sse_file, "                <option value=\"tool_result\">Tool Result Events</option>\n");
        fprintf(sse_file, "            </select>\n");
        fprintf(sse_file, "            <button id=\"apply-filter-btn\">Apply Filter</button>\n");
        fprintf(sse_file, "        </div>\n");
        fprintf(sse_file, "        \n");
